...
export default function Filter() {
  ...
  const [search_attr, setSearch_attr] = useState('');
  ...
  const onSelect = useCallback(
    (value) => {
      ...
      history.push(
        `/permission?page=${query.page}${searchQuery}${selectedFilter}&sort=index&sort=desc`,
      );
    },
  ...
  const onSubmit = useCallback(
    (e) => {
      ...
      history.push('/permission?' + stringify(query));
    },
